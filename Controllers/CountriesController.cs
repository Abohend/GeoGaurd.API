...
public sealed class CountriesController : ControllerBase
{
    ...
    {
        var result = _countryBlockService.AddTemporalBlock(request.CountryCode, request.DurationMinutes);
        return Ok(ApiResponse.Ok(result, "Temporal block added successfully."));
    }
}
